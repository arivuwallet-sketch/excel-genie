...
export const BASIC_TEMPLATES: FinancialTemplate[] = [
    ...
    build: () => [
      ...
      S("Monthly Planner", [
        ...
        [
          "Total",
          ...MONTHS.map(
            (_, m) => `=SUM(${String.fromCharCode(66 + m)}4:${String.fromCharCode(66 + m)}9)`,
          ),
          "=SUM(H4:H9)",
          "=AVERAGE(B10:G10)",
        ],
  ...
  },
  {
    ...
    tier: "Basic",
    blurb:
      "Revenue and expense logs auto-calculating gross margin, operating income and net profit.",
  ...
  },
  {
    ...
    tier: "Basic",
    blurb:
      "Compare snowball (smallest balance first) and avalanche (highest APR first) strategies across every debt, with total interest and a rough payoff timeline.",
    features: [
      "Multi-debt tracker",
    ...
    prompt:
      "Extend this debt payoff planner with a month-by-month amortization schedule for the winning strategy.",
    build: () => [
      S("Debts", [
        ["DEBT PAYOFF PLANNER"],
        [
          "List every balance. Blue cells are inputs; the extra payment goes to whichever debt the strategy targets first.",
        ],
        [],
        ["Debt", "Balance", "APR", "Min Payment", "Monthly Interest"],
        ["Credit Card A", 4200, 0.2399, 120, "=B5*C5/12"],
        ["Credit Card B", 1800, 0.1899, 60, "=B6*C6/12"],
        ["Car Loan", 9600, 0.069, 260, "=B7*C7/12"],
        ["Student Loan", 15400, 0.045, 175, "=B8*C8/12"],
        ["Total", "=SUM(B5:B8)", "", "=SUM(D5:D8)", "=SUM(E5:E8)"],
        [],
      ...
      S("Strategy", [
        ["SNOWBALL vs AVALANCHE"],
        [
          "Snowball orders by smallest balance first (fastest wins, motivating); avalanche orders by highest APR first (least total interest). Same total cash out either way — this compares speed and interest cost.",
        ],
        [],
        ["", "Snowball order", "Avalanche order"],
        [
          "1st payoff target",
          "=INDEX(Debts!$A$5:$A$8,MATCH(MIN(Debts!$B$5:$B$8),Debts!$B$5:$B$8,0))",
          "=INDEX(Debts!$A$5:$A$8,MATCH(MAX(Debts!$C$5:$C$8),Debts!$C$5:$C$8,0))",
        ],
        [
          "2nd payoff target",
          "=INDEX(Debts!$A$5:$A$8,MATCH(SMALL(Debts!$B$5:$B$8,2),Debts!$B$5:$B$8,0))",
          "=INDEX(Debts!$A$5:$A$8,MATCH(LARGE(Debts!$C$5:$C$8,2),Debts!$C$5:$C$8,0))",
        ],
        [],
        ["Total balance today", "=Debts!$B$9"],
        ["Total monthly payment (min + extra)", "=Debts!$D$9+Debts!$B$11"],
        ["Rough months to debt-free (balance / payment)", '=IFERROR(ROUNDUP(B8/B9,0),"-")'],
      ]),
    ],
  },
  {
    id: "rental-property-tracker",
    name: "Rental Property Cash Flow & Cash-on-Cash Return",
    tier: "Basic",
    blurb:
      "Individual-investor rental tracker: monthly income and expenses, reserve allocations, and cash-on-cash return on the cash actually invested.",
    features: [
      "Income & expense breakdown",
      "Maintenance/vacancy reserves",
      "Cash-on-cash return",
      "One tab per property",
    ],
    prompt: "Extend this rental property tracker to compare two properties side by side.",
    build: () => [
      S("Property", [
        ["RENTAL PROPERTY INCOME & RETURN"],
        ["Duplicate this sheet per property. Blue cells are inputs."],
        [],
        ["Purchase price", 285000],
        ["Down payment", 57000],
        ["Closing costs", 6200],
        ["Total cash invested", "=B5+B6"],
        [],
        ["Monthly Income", "Amount"],
        ["Rent", 2200],
        ["Other (parking, laundry)", 75],
        ["Total monthly income", "=SUM(B10:B11)"],
        [],
        ...
        ["Insurance", 95],
        ["HOA", 40],
        ["Maintenance reserve (5% of rent)", "=B12*0.05"],
        ["Vacancy reserve (5% of rent)", "=B12*0.05"],
        ["Property management (8% of rent)", "=B12*0.08"],
        ["Total monthly expenses", "=SUM(B15:B21)"],
        [],
        ["Monthly cash flow", "=B12-B22"],
        ["Annual cash flow", "=B24*12"],
        ["Cash-on-cash return", "=B25/B7"],
      ]),
    ],
  },
  {
    ...
    tier: "Basic",
    blurb:
      "Wedding/event budget with vendor quotes, deposits paid, balances due, and cost-per-guest.",
    features: [
      "Vendor-by-vendor tracker",
      "Deposit vs balance due",
      "Cost per guest",
      "Budget remaining check",
    ],
    prompt: "Extend this event budget planner with a payment-due calendar sorted by date.",
    build: () => [
      S("Budget", [
        ["EVENT BUDGET PLANNER"],
        ["Track vendor quotes, deposits paid and balances due. Blue cells are inputs."],
        [],
        ["Total guest count", 120],
        ["Overall budget", 18000],
        [],
        ["Category", "Vendor", "Quoted", "Deposit Paid", "Balance Due"],
        ["Venue", "Oakview Hall", 6500, 2000, "=C8-D8"],
        ["Catering", "Table & Thyme", 4200, 1000, "=C9-D9"],
        ["Photography", "Lumen Studio", 2100, 500, "=C10-D10"],
        ["Flowers", "Petal Co", 950, 200, "=C11-D11"],
        ["Music / DJ", "MixNight", 1200, 300, "=C12-D12"],
        ["Attire", "", 1800, 900, "=C13-D13"],
        ["Invitations", "", 350, 350, "=C14-D14"],
        ["Misc / buffer", "", 900, 0, "=C15-D15"],
        ["Total", "", "=SUM(C8:C15)", "=SUM(D8:D15)", "=SUM(E8:E15)"],
        [],
        ["Budget remaining (must not be negative)", "=B5-C16"],
        ["Cost per guest", "=C16/B4"],
      ]),
    ],
  },
];
